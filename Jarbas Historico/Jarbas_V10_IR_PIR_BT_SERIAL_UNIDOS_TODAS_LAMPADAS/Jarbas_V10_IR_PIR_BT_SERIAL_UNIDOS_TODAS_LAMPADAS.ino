...
void loop(){
  ...
  if (cmd.length() >0) { 
    ...
    if(cmd == "12"){luzBanheiroSocial1();}
    if(cmd == "13"){luzBanheiroSocial2();}
    if(cmd == "14"){luzBanheiroSuite1();}
    if(cmd == "15"){luzBanheiroSuite2();}    
    if(cmd == "16"){luzQuartoSuite1();}
    if(cmd == "17"){luzQuartoSuite2();}
