      ...
      if(client.available()){
        ...
        if(c == '\n' && continua)
        {
          ...
          if(iniciofrente>-1){     //verifica se o comando veio
            ...
            if      ( acao == "001"){ digitalWrite(HALL, LOW); } 
            else if ( acao == "002"){ digitalWrite(HALL, HIGH);} 
            
            else if ( acao == "003"){ digitalWrite(JANTAR, LOW); }
            else if ( acao == "004"){ digitalWrite(JANTAR, HIGH); }
            else {}
           ...
           // client.print(sensor2);
            client.print(",");
            client.print(" LUZ1 : ");
            client.print(digitalRead(HALL));
            client.print(",");
            client.print(" LUZ2 : ");
            client.print(digitalRead(JANTAR));
            client.print("})");
