...
//byte segundo1, minuto1, hora1, diaDaSemana1, diaDoMes1, mes1, ano1;
int ultimoSegundo;
int ultimoMinuto;
//int i;
...
void loop(){
  ...
  while (Serial3.available()  > 0 ){ 
   cmd = Serial3.read();  
    switch (cmd) { 
        ...
        case 'g':  
           FLAGChaveGeral = OFF; chaveGeral();
        break;
        
        case 'G':  
           FLAGChaveGeral = ON; chaveGeral();
        break;
        
         case 'p':  
           FLAGPorta = 1; Serial.println("Sensor Porta Ligado");
        break;
        
        case 'P':  
           FLAGPorta = 0; Serial.println("Sensor Porta Desligado");
        break;
  ...
  if (readString.length() >0) { 
        ...
        if(readString == "temp ext"){tempExterno();}
        if(readString == "temp int"){tempInterno();}
        if(readString == "temp arthur"){tempInterno();}
        ...
        if(readString == "18"){tomadaQuartoArthur();}
        if(readString == "19"){tomadaQuartoSuite();}
        
        if(readString == "som"){som();}
        if(readString == "som 1"){som1();}
        if(readString == "som 2"){som2();}
        if(readString == "som 3"){som3();}
        if(readString == "som 4"){som4();}
        
        if(readString == "r"){imprimeDadosModulo();}
        if(readString == "porta on") {FLAGPorta = 1; Serial.println("Sensor Porta Ligado");}
        if(readString == "porta off"){FLAGPorta = 0; Serial.println("Sensor Porta Desligado");}
        
        if(readString == "geral on"){FLAGChaveGeral = OFF; chaveGeral();}
        if(readString == "geral off"){FLAGChaveGeral = ON; chaveGeral();}
        
        if(readString == "net history"){ historytNet('S');}
        if(readString == "net globo"){ globoNet('S');}
        if(readString == "net globo news"){ gnewsNet('S');} 
        if(readString == "net discovery kids"){ discoveryKidstNet('S');}
        if(readString == "net cartoon"){ cartoonNet('S');}
        if(readString == "net nick"){ nickNet('S');}
