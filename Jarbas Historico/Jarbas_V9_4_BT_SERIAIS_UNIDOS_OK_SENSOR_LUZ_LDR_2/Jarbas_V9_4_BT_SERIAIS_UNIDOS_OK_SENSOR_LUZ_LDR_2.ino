...
int STATUSJantar;
int STATUSSala;
int STATUSEscritorio;
int STATUSCozinha;
int STATUSArea;
int STATUSCorredor_1;
int STATUSCorredor_2;
int STATUSQuarto_arthur_1;
int STATUSQuarto_arthur_2;
int STATUSQuarto_suite_1;
int STATUSQuarto_suite_2;
int STATUSBanheiro_social_1;
int STATUSBanheiro_social_2;
int STATUSBanheiro_suite_1;
int STATUSBanheiro_suite_2;
 
int sensorLdrHall = A3;     
int valorSensorHall = 0;

int sensorLdrJantar = A4;     
int valorSensorJantar = 0;

//int sensorLdrSala = 5;     
//int valorSensorSala = 5;

//int sensorLdrEscritorio = 6;     
//int valorSensorEscritorio = 6;
...
int valorSensorHall = analogRead(sensorLdrHall);
  if(valorSensorHall > 800){
  if(STATUSHall != 1){
      STATUSHall = 1;
      Serial.println("Ligou Hall");
  }
  }else if(valorSensorHall < 800){
    if(STATUSHall != 0){
      STATUSHall = 0;
  ...
  delay(50);
  int valorSensorJantar = analogRead(sensorLdrJantar);
  if(valorSensorJantar > 800){
  if(STATUSJantar != 1){
      STATUSJantar = 1;
      Serial.println("Ligou Jantar");
  }
  }else if(valorSensorJantar < 800){
    if(STATUSJantar != 0){
      STATUSJantar = 0;
