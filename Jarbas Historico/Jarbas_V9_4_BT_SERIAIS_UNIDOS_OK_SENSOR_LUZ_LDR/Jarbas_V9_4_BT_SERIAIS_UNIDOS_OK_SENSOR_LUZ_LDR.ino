...
int STATUSQuarto_arthur_1 = 2;
int STATUSQuarto_arthur_2 = 2;
...
delay(15);
 ...
 if(valorSensor8 > 800){
   if(STATUSCorredor_2 != 1){
     STATUSCorredor_2 = 1;
     Serial.println("Ligou Spot Corredor");
     
   }
 }else if(valorSensor8 < 800){
   if(STATUSCorredor_2 != 0){
     STATUSCorredor_2 = 0;
     Serial.println("Desligou Spot Corredor");
