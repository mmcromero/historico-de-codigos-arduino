...
// motor pins
#define motorPin1  2     // IN1 on the ULN2803 driver 1
#define motorPin2  3     // IN2 on the ULN2803 driver 1
#define motorPin3  4     // IN3 on the ULN2803 driver 1
#define motorPin4  14     // IN4 on the ULN2803 driver 1
