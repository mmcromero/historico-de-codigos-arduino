 ...
 */   
  ...
  void setup(){ //configurações   
    Serial.begin(9600);
    motor2.attach(7); //declarando em qual porta o motor estará ligado    
    motor2.write(0); //aqui o motor irá "fechar 1 volta"
    delay(1400);  
...
{   
  if(estado == 1){ //fecha
      motor2.write(0); //aqui o motor irá "fechar 2 voltas"
      delay(2800);  
      motor2.write(70); //aqui o motor irá "parar"
  }
  if(estado == 2){
