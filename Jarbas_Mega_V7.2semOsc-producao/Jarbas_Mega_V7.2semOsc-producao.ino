...
EthernetClient client1 = server1.available();
  ...
  //tomadas
    ...
    comando = cmd.substring(0,cmd.length() -1);
    ...
    */
    ...
    if(strTipo == "#"){
      generico(strLocal, comando);
    }
    
/*
    if(comando == "ledLiga"){ledLiga(strLocal); }
    if(comando == "ledDesliga"){ledDesliga(strLocal); }
    if(comando == "ledSobe"){ledSobe(strLocal); }
    if(comando == "ledDesce"){ledDesce(strLocal); }
    if(comando == "ledFlash"){ledFlash(strLocal); }
    if(comando == "ledStrobe"){ledStrobe(strLocal); }
    if(comando == "ledFade"){ledFade(strLocal); }
    if(comando == "ledSmooth"){ledSmooth(strLocal); }
    if(comando == "ledWhite"){ledWhite(strLocal); }
    if(comando == "ledRed"){ledRed(strLocal); }
    if(comando == "ledRed1"){ledRed1(strLocal); }
    if(comando == "ledRed2"){ledRed2(strLocal); }
    if(comando == "ledRed3"){ledRed3(strLocal); }
    if(comando == "ledRed4"){ledRed4(strLocal); }
    if(comando == "ledGreen"){ledGreen(strLocal); }
    if(comando == "ledGreen1"){ledGreen1(strLocal); }
    if(comando == "ledGreen2"){ledGreen2(strLocal); }
    if(comando == "ledGreen3"){ledGreen3(strLocal); }
    if(comando == "ledGreen4"){ledGreen4(strLocal); }
    if(comando == "ledBlue"){ledBlue(strLocal); }
    if(comando == "ledBlue1"){ledBlue1(strLocal); }
    if(comando == "ledBlue2"){ledBlue2(strLocal); }
    if(comando == "ledBlue3"){ledBlue3(strLocal); }
    if(comando == "ledBlue4"){ledBlue4(strLocal); }

    //controle tv
    if(comando == "ligaTvS"){ligaTv(strLocal); }
    if(comando == "inputTv"){inputTv(strLocal); }
    if(comando == "cimaTv"){cimaTv(strLocal); }
    if(comando == "baixoTv"){baixoTv(strLocal); }
    if(comando == "esquerdaTv"){esquerdaTv(strLocal); }
    if(comando == "direitaTv"){direitaTv(strLocal); }
    if(comando == "okTv"){okTv(strLocal); }
    if(comando == "homeTv"){homeTv(strLocal); }
    if(comando == "exitTv"){exitTv(strLocal); }
    if(comando == "qmenuTv"){qmenuTv(strLocal); }
    if(comando == "backTv"){backTv(strLocal); }
    if(comando == "tv3d"){tv3d(strLocal); }
    if(comando == "volumeTvMenos"){volumeTvMenos(strLocal); }
    if(comando == "volumeTvMais"){volumeTvMais(strLocal); }
    if(comando == "canalTvMenos"){canalTvMenos(strLocal); }
    if(comando == "canalTvMais"){canalTvMais(strLocal); }
    if(comando == "playTv"){playTv(strLocal); }
    if(comando == "pauseTv"){pauseTv(strLocal); }
    if(comando == "stopTv"){stopTv(strLocal); }
    if(comando == "rrTv"){rrTv(strLocal); }
    if(comando == "ffTv"){ffTv(strLocal); }
    if(comando == "ratioTv"){ratioTv(strLocal); }
    if(comando == "sleepTv"){sleepTv(strLocal); }
    if(comando == "pictureTv"){pictureTv(strLocal); }
    if(comando == "somTv"){somTv(strLocal); }
*/

  //controle net 
  if(comando == "ligaNet"){ligaNet(strLocal); }
  if(comando == "infoNet"){infoNet(strLocal); }
  if(comando == "portalNet"){portalNet(strLocal); }
  if(comando == "mozaicoNet"){mozaicoNet(strLocal); }
  if(comando == "volMaisNet"){volMaisNet(strLocal); }
  if(comando == "volMenosNet"){volMenosNet(strLocal); }
  if(comando == "canalMaisNet"){canalMaisNet(strLocal); }
  if(comando == "canalMenosNet"){canalMenosNet(strLocal); }
  if(comando == "num1Net"){num1Net(strLocal); }
  if(comando == "num2Net"){num2Net(strLocal); }
  if(comando == "num3Net"){num3Net(strLocal); }
  if(comando == "num4Net"){num4Net(strLocal); }
  if(comando == "num5Net"){num5Net(strLocal); }
  if(comando == "num6Net"){num6Net(strLocal); }
  if(comando == "num7Net"){num7Net(strLocal); }
  if(comando == "num8Net"){num8Net(strLocal); }
  if(comando == "num9Net"){num9Net(strLocal); }
  if(comando == "num0Net"){num0Net(strLocal); }
  if(comando == "cimaNet"){cimaNet(strLocal); }
  if(comando == "baixoNet"){baixoNet(strLocal); }
  if(comando == "esquerdaNet"){esquerdaNet(strLocal); }
  if(comando == "direitaNet"){direitaNet(strLocal); }
  if(comando == "okNet"){okNet(strLocal); }
  if(comando == "muteNet"){muteNet(strLocal); }
  if(comando == "voltarNet"){voltarNet(strLocal); }
  if(comando == "favNet"){favNet(strLocal); }
  if(comando == "menuNet"){menuNet(strLocal); }
  if(comando == "sairNet"){sairNet(strLocal); }
  if(comando == "nowNet"){nowNet(strLocal); }
  if(comando == "audioNet"){audioNet(strLocal); }
  if(comando == "agoraNet"){agoraNet(strLocal); }
  if(comando == "legendaNet"){legendaNet(strLocal); }
  if(comando == "musicaNet"){musicaNet(strLocal); }
  if(comando == "rrNet"){rrNet(strLocal); }
  if(comando == "playPauseNet"){playPauseNet(strLocal); }
  if(comando == "stopNet"){stopNet(strLocal); }
  if(comando == "ffNet"){ffNet(strLocal); }
  if(comando == "recNet"){recNet(strLocal); }
  if(comando == "netTvNet"){netTvNet(strLocal); }
  ...
  //sub
  if(cmd == "powerSub"){powerSub("M"); }
  if(cmd == "volMenosSub"){volMenosSub("M"); }
  if(cmd == "volMaisSub"){volMaisSub("M"); }
  if(cmd == "inputSub"){inputSub(strLocal); }
  if(cmd == "modeSub"){modeSub(strLocal); }
  if(cmd == "swMenosSub"){swMenosSub(strLocal); }
  if(cmd == "swMaisSub"){swMaisSub(strLocal); }
  ...
  //mostradores
    ...
    // teste função generica ir
    //0xF740BF - des
    //0xF7C03F - lig
    //generico(local, codigo)
    
    if(cmd == "testeGenerico1"){ generico("S", "0xF740BF");}
    if(cmd == "testeGenerico2"){ generico("S", "0xF7C03F");}
