...
void setup(){ 
  ...
  if (client1.connect(serverName, 80)) {
    Serial.println("connected");
    // Make a HTTP request:
    client1.println("GET /arduino/jarbas-mala/statusLuz.php?ldr1=0&ldr2=0&ldr3=0&ldr4=0&ldr5=0&ldr6=0&ldr7=0&ldr8=0&ldr9=0&ldr10=0&ldr11=0&ldr12=0&ldr13=0&ldr14=0&ldr15=0&ldr16=0&ldr17=0&ldr18=0&ldr19=0");
    Serial.println("Zera variaveis de iluminacao no BD");
    client1.println();
...
void sendLdrStatus()
{
  if (client1.connect(serverName, 80)) {
    Serial.println("connected");
    //client1.println("GET /arduino/_LAB/salva_bd/add.php?ldr1=0&ldr2=0&ldr3=0&ldr4=0&ldr5=0&ldr6=0&ldr7=0&ldr8=0&ldr9=0&ldr10=0&ldr11=0&ldr12=0&ldr13=0&ldr14=0&ldr15=0&ldr16=0&ldr17=0&ldr18=0&ldr19=0");
    //client1.print("GET /jarbas/statusLuz.php?ldr1="); //Produçao
    client1.print("GET /arduino/jarbas-mala/statusLuz.php?ldr1="); //Mala
    client1.print(STATUSRele1); // passa a temperatura por parametro
    client1.print("&ldr2="); //captura a página do servidor inclui a temperatura
    client1.print(STATUSRele2); // passa a temperatura por parametro
    client1.print("&ldr3="); //captura a página do servidor inclui a temperatura
    client1.print(STATUSFitaLed1); // passa a temperatura por parametro
    client1.print("&ldr4="); //captura a página do servidor inclui a temperatura
    client1.print(STATUSRele3); // passa a temperatura por parametro
    client1.print("&ldr5="); //captura a página do servidor inclui a temperatura
    client1.print(STATUSRele4); // passa a temperatura por parametro
    client1.print("&ldr6="); //captura a página do servidor inclui a temperatura
    client1.print(STATUSRele5); // passa a temperatura por parametro
    client1.print("&ldr7="); //captura a página do servidor inclui a temperatura
    client1.print(STATUSRele6); // passa a temperatura por parametro
    client1.print("&ldr8="); //captura a página do servidor inclui a temperatura
    client1.print(STATUSRele7); // passa a temperatura por parametro
    client1.print("&ldr9="); //captura a página do servidor inclui a temperatura
    client1.print(STATUSRele8); // passa a temperatura por parametro
    client1.print("&ldr10="); //captura a página do servidor inclui a temperatura
    client1.print(STATUSRele9); // passa a temperatura por parametro
    client1.print("&ldr11="); //captura a página do servidor inclui a temperatura
    client1.print(STATUSFitaLed2); // passa a temperatura por parametro
    client1.print("&ldr12="); //captura a página do servidor inclui a temperatura
    client1.print(STATUSRele10); // passa a temperatura por parametro
    client1.print("&ldr13="); //captura a página do servidor inclui a temperatura
    client1.print(STATUSFitaLed3); // passa a temperatura por parametro
    client1.print("&ldr14="); //captura a página do servidor inclui a temperatura
    client1.print(STATUSRele11); // passa a temperatura por parametro
    client1.print("&ldr15="); //captura a página do servidor inclui a temperatura
    client1.print(STATUSRele12); // passa a temperatura por parametro
    client1.print("&ldr16="); //captura a página do servidor inclui a temperatura
    client1.print(STATUSRele13); // passa a temperatura por parametro
    client1.print("&ldr17="); //captura a página do servidor inclui a temperatura
    client1.print(STATUSRele14 ); // passa a temperatura por parametro
    client1.print("&ldr18="); //captura a página do servidor inclui a temperatura
    client1.print(STATUSTvSala); // passa a temperatura por parametro
    client1.print("&ldr19="); //captura a página do servidor inclui a temperatura
    client1.println(STATUSTvArthur); // passa a temperatura por parametro
    client1.println(" HTTP/1.1"); //protocolo http
    client1.println();
    Serial.println("modifica variavel de iluminacao no BD");
    Serial.println("disconnecting.");
    Serial.println(STATUSRele13);
    delay(50);
    client1.stop();
  }else {
