...
int sensibilidadeSensor15 = 1000; // tv sala
int sensibilidadeSensor16 = 1000; // tv arthur

int sensibilidadeSensor17 = 650; // fita led 1
int sensibilidadeSensor18 = 650; // fita led 2
int sensibilidadeSensor19 = 650; // fita led 3
...
//  em seguida, lê o valor do sensor correspondente, que vai estar disponível no pino A5    
    ...
    if(i == 0){
       valorSensor1 = sensorValue; // hall
    }else if(i == 1){
       valorSensor2 = sensorValue; // jantar
    }else if(i == 2){
       valorSensor3 = sensorValue; // mesa sala
    }else if(i == 3){
       valorSensor4 = sensorValue; // escritorio
    }else if(i == 4){
       valorSensor5 = sensorValue; // cozinha
    }else if(i == 5){
       valorSensor6 = sensorValue; // area
    }else if(i == 6){
       valorSensor7 = sensorValue; // corredor 1
    }else if(i == 7){
       valorSensor8 = sensorValue; // corredor 2
    }else if(i == 8){
       valorSensor9 = sensorValue; // arthur 1
    }else if(i == 9){
       valorSensor10 = sensorValue; // casal 1
    }else if(i == 10){
       valorSensor11 = sensorValue; // wc social 1
    }else if(i == 11){
       valorSensor12 = sensorValue; // wc social 2
    }else if(i == 12){
       valorSensor13 = sensorValue; // wc suite 1
    }else if(i == 13){
       valorSensor14 = sensorValue; // wc suite 2 
    }else if(i == 14){
       valorSensor15 = sensorValue; // tv sala
    }else if(i == 15){
       valorSensor16 = sensorValue; // tv arthur
    }else{
      valorSensor1 = 9;
      valorSensor2 = 9;
      valorSensor3 = 9;
