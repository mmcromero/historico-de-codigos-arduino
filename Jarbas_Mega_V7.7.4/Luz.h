...
void luzSala()
{
  ...
  if (!FLAGSala) {  
    ...
    digitalWrite(NEGATIVOIRMESASALA, HIGH);
    for (int i = 0; i < 5; i++) {
...
void tomadaMesaSala()
{
  if (!FLAGMesa_sala) {  
    ...
    Serial.println("tomada mesa high"); 
  }else{  
    FLAGMesa_sala = LOW;  
    digitalWrite(RELE3, FLAGMesa_sala); 
    Serial.println("tomada mesa low"); 
  } 
}
...
void tomadaQuartoArthur()
{
  if (!FLAGQuarto_arthur_3) {  
    ...
    Serial.println("tomada arthur high");  
  }else{  
    FLAGQuarto_arthur_3 = LOW;  
    digitalWrite(RELE15, FLAGQuarto_arthur_3);  
    Serial.println("tomada arthur low");
  } 
}
...
void tomadaQuartoSuite()
{
  if (!FLAGQuarto_suite_3) {  
    ...
    Serial.println("tomada suite high"); 
  }else{  
    FLAGQuarto_suite_3 = LOW;  
    digitalWrite(RELE16, FLAGQuarto_suite_3);
    Serial.println("tomada suite low");  
  } 
}
