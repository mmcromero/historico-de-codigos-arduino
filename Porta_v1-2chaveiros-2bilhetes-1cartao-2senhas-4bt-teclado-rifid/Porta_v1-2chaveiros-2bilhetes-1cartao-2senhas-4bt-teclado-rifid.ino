...
void botoes()
{
  ...
  if(tecladoA0 > intBt3-variacao and tecladoA0 < intBt3+variacao){
    if(modoCalibracao == 1){
      ...
      servoMotorObj1.write(50); //180 aqui o motor irá "fechar"
    }
  }else if(tecladoA0 > intBt4-variacao and tecladoA0 < intBt4+variacao){
    if(modoCalibracao == 1){
      Serial.println("Bt 4 - Abertado"); Serial.println("");
      servoMotorObj1.write(90); //180 aqui o motor irá "fechar"
    }
  }else{
    servoMotorObj1.write(70); //70 aqui o motor irá "parar"
  }
  ...
  if(salvaSenha == 1){
    ...
    */
    //if(valorSMDb == 1){
      ...
      if (keypressed == senha1[position1] || keypressed == senha2[position2] || keypressed == senha3[position3]){
        position1 ++;
        position2 ++;
        position3 ++;
      }
      if (position1 >= 6 || position2 >= 6 || position3 >= 6){
