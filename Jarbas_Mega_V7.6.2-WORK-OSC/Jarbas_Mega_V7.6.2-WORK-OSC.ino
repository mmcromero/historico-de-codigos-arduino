...
/* ------------------------------------------------------------------ OSC ------------------------------------------------------------------ */
  ...
  serverOsc.addCallback("/ard/luzHall",&luz1);
  /*serverOsc.addCallback("/ard/luzJantar",&luz2);
  serverOsc.addCallback("/ard/luzSala",&luz3);
  serverOsc.addCallback("/ard/luzMesaSala",&luz4);
  serverOsc.addCallback("/ard/luzQuartinho",&luz5);
  serverOsc.addCallback("/ard/luzCozinha",&luz6);
  serverOsc.addCallback("/ard/luzArea",&luz7);
  serverOsc.addCallback("/ard/luzCorredor1",&luz8);
  serverOsc.addCallback("/ard/luzCorredor2",&luz9);
  serverOsc.addCallback("/ard/luzQuartoArthur1",&luz10); 
  serverOsc.addCallback("/ard/luzQuartoArthur2",&luz11); 
  serverOsc.addCallback("/ard/luzQuartoSuite1",&luz12); 
  serverOsc.addCallback("/ard/luzQuartoSuite2",&luz13); 
  serverOsc.addCallback("/ard/luzBanheiroSocial1",&luz14); 
  serverOsc.addCallback("/ard/luzBanheiroSocial2",&luz15); 
  serverOsc.addCallback("/ard/luzBanheiroSuite1",&luz16); 
  serverOsc.addCallback("/ard/luzBanheiroSuite2",&luz17);  
  //controle led
  serverOsc.addCallback("/ard/controleLedSala",&controleLedSalaOsc);
  serverOsc.addCallback("/ard/controleLedArthur",&controleLedArthurOsc);
  //controle tv
  serverOsc.addCallback("/ard/controleTvSala",&controleTvSalaOsc); 
  serverOsc.addCallback("/ard/controleTvArthur",&controleTvArthurOsc);
  //controle net
  serverOsc.addCallback("/ard/controleNetSala",&controleNetSalaOsc);
  serverOsc.addCallback("/ard/controleNetArthur",&controleNetArthurOsc);
  //controle sub
  serverOsc.addCallback("/ard/controleSub",&controleSubOsc);
  //controle Geral
  serverOsc.addCallback("/ard/controleGeral",&controleGeralOsc);
  serverOsc.addCallback("/ard/telas",&telasOsc);*/
/* ------------------------------------------------------------------ OSC ------------------------------------------------------------------ */
