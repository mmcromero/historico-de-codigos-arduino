...
void sensorLuz()
{
  ...
  if(mostrasensorLdr == 1){
    ...
    Serial.print(statusEsq);
    Serial.print(" - ");
    Serial.print(statusEsq_Db);
    Serial.print(" - ");
    Serial.println(timeOffDelayLdr);
  }
