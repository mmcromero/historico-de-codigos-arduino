...
//generico
void sendIr(String strLocal, String strValue)
{   
  ...
  if(strLocal != "C"){digitalWrite(NEGATIVOIRCASAL, HIGH); }
    ...
    for (int i = 0; i < 5; i++) {
      ...
      //CONTROLE SUB repetição 2
      if(strValue == "#powerSub"){ irsend.sendNEC(0x18E738C7, 32); } //powerSub
      if(strValue == "#inputSub"){ irsend.sendNEC(0x18E7A857, 32); } //inputSub
      if(strValue == "#modeSub"){ irsend.sendNEC(0x18E720DF, 32); } //modeSub
      if(strValue == "#swMenosSub"){ irsend.sendNEC(0x18E7B847, 32); } //swMenosSub
      if(strValue == "#swMaisSub"){ irsend.sendNEC(0x18E710EF, 32); } //swMaisSub
      if(strValue == "#volMenosSub"){ irsend.sendNEC(0x18E7B04F, 32); } //volMenosSub
      if(strValue == "#volMaisSub"){ irsend.sendNEC(0x18E708F7, 32); } //volMaisSub
