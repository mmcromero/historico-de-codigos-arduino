...
EthernetClient client1 = server1.available();
  ...
  //tomadas
    ...
    //controle tv
    if(cmdR == "ligaTvS"){ligaTv(strLocal); }
  ...
  /*
  if(cmdR == "historytNet"){historytNet(strLocal); }
  if(cmdR == "globoNet"){globoNet(strLocal); }
  if(cmdR == "gnewsNet"){gnewsNet(strLocal); }
  if(cmdR == "discoveryKidstNet"){discoveryKidstNet(strLocal); }
  if(cmdR == "cartoonNet"){cartoonNet(strLocal); }
  if(cmdR == "nickNet"){nickNet(strLocal); }
  if(cmdR == "foxNet"){foxNet(strLocal); }
  */
  //sub
  ...
  /*
  if(cmdR == "inputSub"){inputSub(strLocal); }
  if(cmdR == "modeSub"){modeSub(strLocal); }
  if(cmdR == "swMenosSub"){swMenosSub(strLocal); }
  if(cmdR == "swMaisSub"){swMaisSub(strLocal); }
