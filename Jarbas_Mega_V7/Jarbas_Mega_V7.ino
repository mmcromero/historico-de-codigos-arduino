...
EthernetClient client1 = server1.available();
  ...
  stringTwo.concat(valorSensor1);
  stringTwo.concat('|');
  stringTwo.concat(valorSensor2);
  stringTwo.concat('|');
  stringTwo.concat(valorSensor3);
  stringTwo.concat('|');
  stringTwo.concat(valorSensor4);
  stringTwo.concat('|');
  stringTwo.concat(valorSensor5);
  stringTwo.concat('|');
  stringTwo.concat(valorSensor6);
  stringTwo.concat('|');
  stringTwo.concat(valorSensor7);
  stringTwo.concat('|');
  stringTwo.concat(valorSensor8);
  stringTwo.concat('|');
  stringTwo.concat(valorSensor9);
  stringTwo.concat('|');
  stringTwo.concat(valorSensor10);
  stringTwo.concat('|');
  stringTwo.concat(valorSensor11);
  stringTwo.concat('|');
  stringTwo.concat(valorSensor12);
  stringTwo.concat('|');
  stringTwo.concat(valorSensor13);
  stringTwo.concat('|');
  stringTwo.concat(valorSensor14);
  stringTwo.concat('|');
  stringTwo.concat(valorSensor15);
  stringTwo.concat('|');
  stringTwo.concat(valorSensor16);
  stringTwo.concat('|');
  stringTwo.concat(valorSensor17);
  stringTwo.concat('|');
  stringTwo.concat(valorSensor18);
  stringTwo.concat('|');
  stringTwo.concat(valorSensor19);
  //stringTwo.concat('|');
...
sensorLdrWcSuite2
  */
  ...
  client1.print("valorLdr : ");
  client1.print(stringTwo);
  /*
  client1.print(",");
  client1.print(" ldr1 : ");
  client1.print(valorSensor1);
  client1.print(",");
  client1.print(" ldr2 : ");
  client1.print(valorSensor2);
  client1.print(",");
  client1.print(" ldr3 : ");
  client1.print(valorSensor3);
  client1.print(",");
  client1.print(" ldr4 : ");
  client1.print(valorSensor4);
  client1.print(",");
  client1.print(" ldr5 : ");
  client1.print(valorSensor5);
  client1.print(",");
  client1.print(" ldr6 : ");
  client1.print(valorSensor6);
  client1.print(",");
  client1.print(" ldr7 : ");
  client1.print(valorSensor7);
  client1.print(",");
  client1.print(" ldr8 : ");
  client1.print(valorSensor8);
  client1.print(",");
  client1.print(" ldr9 : ");
  client1.print(valorSensor9);
  client1.print(",");
  client1.print(" ldr10 : ");
  client1.print(valorSensor10);
  client1.print(",");
  client1.print(" ldr11 : ");
  client1.print(valorSensor11);
  client1.print(",");
  client1.print(" ldr12 : ");
  client1.print(valorSensor12);
  client1.print(",");
  client1.print(" ldr13 : ");
  client1.print(valorSensor13);
  client1.print(",");
  client1.print(" ldr14 : ");
  client1.print(valorSensor14);
  client1.print(",");
  client1.print(" ldr15 : ");
  client1.print(valorSensor15);
  client1.print(",");
  client1.print(" ldr16 : ");
  client1.print(valorSensor16);
  client1.print(",");
  client1.print(" ldr17 : ");
  client1.print(valorSensor17);
  client1.print(",");
  client1.print(" ldr18 : ");
  client1.print(valorSensor18);
  client1.print(",");
  client1.print(" ldr19 : ");
  client1.print(valorSensor19);
  
  */
  
  // valor sensibilidade  do sensor ldr
  client1.print(",");
  client1.print(" sensibilidadeLdr1 : ");
  client1.print(sensibilidadeSensor1);
  /*
  client1.print(",");
  client1.print(" sensibilidadeLdr2 : ");
  client1.print(sensibilidadeSensor2);
  client1.print(",");
  client1.print(" sensibilidadeLdr3 : ");
  client1.print(sensibilidadeSensor3);
  client1.print(",");
  client1.print(" sensibilidadeLdr4 : ");
  client1.print(sensibilidadeSensor4);
  client1.print(",");
  client1.print(" sensibilidadeLdr5 : ");
  client1.print(sensibilidadeSensor5);
  client1.print(",");
  client1.print(" sensibilidadeLdr6 : ");
  client1.print(sensibilidadeSensor6);
  client1.print(",");
  client1.print(" sensibilidadeLdr7 : ");
  client1.print(sensibilidadeSensor7);
  client1.print(",");
  client1.print(" sensibilidadeLdr8 : ");
  client1.print(sensibilidadeSensor8);
  client1.print(",");
  client1.print(" sensibilidadeLdr9 : ");
  client1.print(sensibilidadeSensor9);
  client1.print(",");
  client1.print(" sensibilidadeLdr10 : ");
  client1.print(sensibilidadeSensor10);
  client1.print(",");
  client1.print(" sensibilidadeLdr11 : ");
  client1.print(sensibilidadeSensor11);
  client1.print(",");
  client1.print(" sensibilidadeLdr12 : ");
  client1.print(sensibilidadeSensor12);
  client1.print(",");
  client1.print(" sensibilidadeLdr13 : ");
  client1.print(sensibilidadeSensor13);
  client1.print(",");
  client1.print(" sensibilidadeLdr14 : ");
  client1.print(sensibilidadeSensor14);
  client1.print(",");
  client1.print(" sensibilidadeLdr15 : ");
  client1.print(sensibilidadeSensor15);
  client1.print(",");
  client1.print(" sensibilidadeLdr16 : ");
  client1.print(sensibilidadeSensor16);
  client1.print(",");
  client1.print(" sensibilidadeLdr17 : ");
  client1.print(sensibilidadeSensor17);
  client1.print(",");
  client1.print(" sensibilidadeLdr18 : ");
  client1.print(sensibilidadeSensor18);
  client1.print(",");
  client1.print(" sensibilidadeLdr19 : ");
  client1.print(sensibilidadeSensor19);
  */
  // estado do sensor determinado pela sensibilidade em relação ao valor da teitura
  client1.print(",");
  client1.print(" sensorLdr : ");
  client1.print(STATUSRele1);
  /*
  client1.print(",");
  client1.print(" sensorLdrJantar : ");
  client1.print(STATUSRele2);
  client1.print(",");
  client1.print(" sensorLdrSala : ");
  client1.print(STATUSFitaLed1);
  client1.print(",");
  client1.print(" sensorLdrMesaSala : ");
  client1.print(STATUSRele3);
  client1.print(",");
  client1.print(" sensorLdrQuartinho : ");
  client1.print(STATUSRele4);
  client1.print(",");
  client1.print(" sensorLdrCozinha : ");
  client1.print(STATUSRele5);
  client1.print(",");
  client1.print(" sensorLdrArea : ");
  client1.print(STATUSRele6);
  client1.print(",");
  client1.print(" sensorLdrCorredor1 : ");
  client1.print(STATUSRele7);
  client1.print(",");
  client1.print(" sensorLdrCorredor2 : ");
  client1.print(STATUSRele8);
  client1.print(",");
  client1.print(" sensorLdrArthur1 : ");
  client1.print(STATUSRele9);
  client1.print(",");
  client1.print(" sensorLdrArthur2 : ");
  client1.print(STATUSFitaLed2);
  client1.print(",");
  client1.print(" sensorLdrSuite1 : ");
  client1.print(STATUSRele10);
  client1.print(",");
  client1.print(" sensorLdrSuite2 : ");
  client1.print(STATUSFitaLed3);
  client1.print(",");
  client1.print(" sensorLdrWcSocial1 : ");
  client1.print(STATUSRele11);
  client1.print(",");
  client1.print(" sensorLdrWcSocial2 : ");
  client1.print(STATUSRele12);
  client1.print(",");
  client1.print(" sensorLdrWcSuite1 : ");
  client1.print(STATUSRele13);
  client1.print(",");
  client1.print(" sensorLdrWcSuite2 : ");
  client1.print(STATUSRele14);
*/
  //DHT11
  //sensor1
  client1.print(",");
  client1.print(" dht11ExternoTemp : ");
  client1.print(dht11ExternoTemp);
  client1.print(",");
  client1.print(" dht11ExternoUmi :  ");
  client1.print(dht11ExternoUmi);
/* 
  //sensor2
  
  client1.print(",");
  client1.print(" dht11SalaTemp : ");
  client1.print(dht11SalaTemp);
  client1.print(",");
  client1.print(" dht11SalaUmi :  ");
  client1.print(dht11SalaUmi);
  
  //sensor3
  client1.print(",");
  client1.print(" dht11ArthurTemp : ");
  client1.print(dht11ArthurTemp);
  client1.print(",");
  client1.print(" dht11ArthurUmi :  ");
  client1.print(dht11ArthurUmi);
  //sensor4
  client1.print(",");
  client1.print(" dht11CasalTemp : ");
  client1.print(dht11CasaTemp);
  client1.print(",");
  client1.print(" dht11CasalUmi :  ");
  client1.print(dht11CasaUmi);
  */
 
  //PIR
  client1.print(",");
  client1.print(" valorPirPorta : ");
  client1.print(valorPir);
  client1.print(",");
  client1.print(" ativaPirPorta : ");
  client1.print(FLAGPirHall);

  //SM
  client1.print(",");
  client1.print(" valorSmPorta : ");
  client1.print(valorSM);
  client1.print(",");
  client1.print(" ativaSmPorta : ");
  client1.print(FLAGSmPorta);
  ...
  client1.print("})");
            ...
            client1.print("dados({ sensor1 : ");
            client1.print(sensor1);
            client1.print(", sensor2 :  ");
            client1.print(sensor2);
            client1.print(",");
            client1.print(" LUZ1 : ");
            client1.print(digitalRead(LUZ1));
            client1.print(",");
            client1.print(" LUZ2 : ");
            client1.print(digitalRead(LUZ2));
            client1.print("})");
            */
          break;
...
//Serial.println(dht11Externo('U'));
  ...
  Serial.println(dht11ExternoTemp );
  Serial.println( dht11ExternoUmi);
  Serial.println(dht11SalaTemp );
  Serial.println(dht11SalaUmi );
  Serial.println(dht11ArthurTemp );
  Serial.println(dht11ArthurUmi );
  Serial.println(dht11CasaTemp );
  Serial.println(dht11CasaUmi );
