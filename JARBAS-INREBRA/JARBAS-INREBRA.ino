String jarbasVersion = " Jarbas INREBRA ";
...
// TESTE
  ...
  byte myIp[]  = { 192, 168, 0, 65 };   //define IP da central automação 2
//PRODUÇÃO
...
/* ------------------------------------------------------------------ PIR ------------------------------------------------------------------ */
// sensor presença
char pinopir = 46;  //Pino ligado ao sensor PIR
...
//pir
char timeOffDelay = 0;
char setLimiteDelay = 60;

char  RELE1 = 22; // luzHall
char  RELE2 = 23; // luzJantar
char  RELE4 = 25; // luzQuartinho
char  RELE5 = 26; // luzCozinha
char  RELE6 = 27; // luzArea
char  RELE7 = 28; // luzCorredor1
char  RELE8 = 29; // luzCorredor2
char  RELE9 = 30; // luzQuartoArthur1
char  RELE10 = 31;// QuartoCasal
char  RELE11 = 32;// luzBanheiroSocial1
char  RELE12 = 33;// luzBanheiroSocial2
char  RELE13 = 34;// luzBanheiroSuite1
char  RELE14 = 35;// luzBanheiroSuite2

char  RELE3 = 24; // tomadaMesaSala
char  RELE15 = 36;// TomadaQuartoArthur
char  RELE16 = 37;// TomadaQuartoSuite

// Flags de controle ILUMINAÇÃO
boolean STATUSRele1 = 2;
boolean STATUSRele2 = 2;
boolean STATUSRele3 = 2;
boolean STATUSRele4 = 2;
boolean STATUSRele5 = 2;
boolean STATUSRele6 = 2;
boolean STATUSRele7 = 2;
boolean STATUSRele8 = 2;
boolean STATUSRele9 = 2;
boolean STATUSRele10 = 2;
boolean STATUSRele11 = 2;
boolean STATUSRele12 = 2;
boolean STATUSRele13 = 2;
boolean STATUSRele14 = 2;
boolean STATUSRele15 = 2;
boolean STATUSRele16 = 2;

boolean STATUSTvSala = 2;
boolean STATUSTvArthur = 2;

boolean STATUSFitaLed1 = 2;
boolean STATUSFitaLed2 = 2;
boolean STATUSFitaLed3 = 2;
boolean STATUSFitaLed4 = 2;
