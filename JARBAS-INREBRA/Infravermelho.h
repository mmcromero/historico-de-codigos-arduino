...
{   
  ...
  if(strLocal != "C"){digitalWrite(NEGATIVOIRCASAL, HIGH); }
    ...
    for (int i = 0; i < intRepeticao; i++) {
      ...
      //CONTROLE RECIVER repetição 2
      //if(strValue == "powerReciver"){ irsend.sendNEC(, 32); } //powerSub
      //if(strValue == "inputReciver"){ irsend.sendNEC(, 32); } //inputSub
      //if(strValue == "modeReciver"){ irsend.sendNEC(, 32); } //modeSub
      //if(strValue == "swMenosReciver"){ irsend.sendNEC(, 32); } //swMenosSub
      //if(strValue == "swMaisReciver"){ irsend.sendNEC(, 32); } //swMaisSub

     // 5EA1B847  //liga
     // 5EA17887  //desliga

     // 5EA1837C  //input dvd (tv)
     // 5EA1A857  //input cd (aux)
     // 5EA16897  //input radio
