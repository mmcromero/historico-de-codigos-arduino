...
int valorSensor1 = 0;   // Hall  
int valorSensor2 = 0;   // Jantar - area muito clara valor 900 
int valorSensor3 = 0;   // 
int valorSensor4 = 0;   // escritorio
int valorSensor5 = 0;   // cozinha
int valorSensor6 = 0;   // Area - area muito clara valor 900
int valorSensor7 = 0;   // corredor 1
int valorSensor8 = 0;   // corredor 2
int valorSensor9 = 0;   // quarto arthur 1
int valorSensor10 = 0;  // quarto casal
int valorSensor11 = 0;  // wc social 1
int valorSensor12 = 0;  // wc social 2
int valorSensor13 = 0;  // wc suite 1  - area muito clara valor 900
int valorSensor14 = 0;  // wc suite 2 
int valorSensor15 = 0;  // temp
int valorSensor16 = 0;
int valorSensor17 = 0;
int valorSensor18 = 0;
int valorSensor19 = 0;
