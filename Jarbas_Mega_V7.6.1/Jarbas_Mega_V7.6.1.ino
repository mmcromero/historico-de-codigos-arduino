...
// TESTE = 0
// PRODUÇÃO = 1
String jarbasVersion = " Jarbas V-7.6.1 ";
int ambiente = 0;
...
void loop(){
  ...
  */  
  ...
  {  
    ...
    if (armazenavalor ==                              0x20DF32CD ) { //ligaTv("A");         
  }//Verifica se a tecla list foi acionada
    if (armazenavalor ==                              0x20DF08F7 ) { luzCorredor2();      }//Verifica se a tecla 0 foi acionada 
    if (armazenavalor ==                              0x20DF58A7 ) { luzQuartoArthur2(); //okTv("S"); 
  }//Verifica se a tecla qview foi acionada 
