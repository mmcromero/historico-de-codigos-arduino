...
//  em seguida, lê o valor do sensor correspondente, que vai estar disponível no pino A5    
  ...
  if(valorSensor1 < sensibilidadeSensor){
    if(STATUSRele1 != 1){
        ...
        if(valorSensor1 > frenteVal-50 && valorSensor1 < frenteVal+50){Serial.println("frente");} 
        if(valorSensor1 > trasVal-50 && valorSensor1 < trasVal+50 ){Serial.println("tras");} 
        if(valorSensor1 > direitaVal-50 && valorSensor1 < direitaVal+50){Serial.println("direita");} 
        if(valorSensor1 > esquerdaVal-50 && valorSensor1 < esquerdaVal+50){Serial.println("esquerda");}  
        if(valorSensor1 > functionVal-50 && valorSensor1 < functionVal+50){Serial.println("function");}  
   ...
   if(valorSensor2 < sensibilidadeSensor){
    if(STATUSRele2 != 1){
        ...
        if(valorSensor2 > frenteVal-50 && valorSensor1 < frenteVal+50){Serial.println("frente");} 
        if(valorSensor2 > trasVal-50 && valorSensor1 < trasVal+50 ){Serial.println("tras");} 
        if(valorSensor2 > direitaVal-50 && valorSensor1 < direitaVal+50){Serial.println("direita");} 
        if(valorSensor2 > esquerdaVal-50 && valorSensor1 < esquerdaVal+50){Serial.println("esquerda");}  
        if(valorSensor2 > functionVal-50 && valorSensor1 < functionVal+50){Serial.println("function");}  
  ...
  if(valorSensor3 < sensibilidadeSensor){
    if(STATUSRele3 != 1){
        ...
        if(valorSensor3 > frenteVal-50 && valorSensor1 < frenteVal+50){Serial.println("frente");} 
        if(valorSensor3 > trasVal-50 && valorSensor1 < trasVal+50 ){Serial.println("tras");} 
        if(valorSensor3 > direitaVal-50 && valorSensor1 < direitaVal+50){Serial.println("direita");} 
        if(valorSensor3 > esquerdaVal-50 && valorSensor1 < esquerdaVal+50){Serial.println("esquerda");}  
        if(valorSensor3 > functionVal-50 && valorSensor1 < functionVal+50){Serial.println("function");}  
  ...
  if(valorSensor4 < sensibilidadeSensor){
    if(STATUSRele4 != 1){
        ...
        if(valorSensor4 > frenteVal-50 && valorSensor1 < frenteVal+50){Serial.println("frente");} 
        if(valorSensor4 > trasVal-50 && valorSensor1 < trasVal+50 ){Serial.println("tras");} 
        if(valorSensor4 > direitaVal-50 && valorSensor1 < direitaVal+50){Serial.println("direita");} 
        if(valorSensor4 > esquerdaVal-50 && valorSensor1 < esquerdaVal+50){Serial.println("esquerda");}  
        if(valorSensor4 > functionVal-50 && valorSensor1 < functionVal+50){Serial.println("function");}  
  ...
  if(valorSensor5 < sensibilidadeSensor){
    if(STATUSRele5 != 1){
        ...
        if(valorSensor5 > frenteVal-50 && valorSensor1 < frenteVal+50){Serial.println("frente");} 
        if(valorSensor5 > trasVal-50 && valorSensor1 < trasVal+50 ){Serial.println("tras");} 
        if(valorSensor5 > direitaVal-50 && valorSensor1 < direitaVal+50){Serial.println("direita");} 
        if(valorSensor5 > esquerdaVal-50 && valorSensor1 < esquerdaVal+50){Serial.println("esquerda");}  
        if(valorSensor5 > functionVal-50 && valorSensor1 < functionVal+50){Serial.println("function");}  
  ...
  if(valorSensor6 < sensibilidadeSensor){
    if(STATUSRele6 != 1){
        ...
        if(valorSensor6 > frenteVal-50 && valorSensor1 < frenteVal+50){Serial.println("frente");} 
        if(valorSensor6 > trasVal-50 && valorSensor1 < trasVal+50 ){Serial.println("tras");} 
        if(valorSensor6 > direitaVal-50 && valorSensor1 < direitaVal+50){Serial.println("direita");} 
        if(valorSensor6 > esquerdaVal-50 && valorSensor1 < esquerdaVal+50){Serial.println("esquerda");}  
        if(valorSensor6 > functionVal-50 && valorSensor1 < functionVal+50){Serial.println("function");}  
  ...
  if(valorSensor7 < sensibilidadeSensor){
    if(STATUSRele7 != 1){
        ...
        if(valorSensor7 > frenteVal-50 && valorSensor1 < frenteVal+50){Serial.println("frente");} 
        if(valorSensor7 > trasVal-50 && valorSensor1 < trasVal+50 ){Serial.println("tras");} 
        if(valorSensor7 > direitaVal-50 && valorSensor1 < direitaVal+50){Serial.println("direita");} 
        if(valorSensor7 > esquerdaVal-50 && valorSensor1 < esquerdaVal+50){Serial.println("esquerda");}  
        if(valorSensor7 > functionVal-50 && valorSensor1 < functionVal+50){Serial.println("function");}  
  ...
  if(valorSensor8 < sensibilidadeSensor){
    if(STATUSRele8 != 1){
        ...
        if(valorSensor8 > frenteVal-50 && valorSensor1 < frenteVal+50){Serial.println("frente");} 
        if(valorSensor8 > trasVal-50 && valorSensor1 < trasVal+50 ){Serial.println("tras");} 
        if(valorSensor8 > direitaVal-50 && valorSensor1 < direitaVal+50){Serial.println("direita");} 
        if(valorSensor8 > esquerdaVal-50 && valorSensor1 < esquerdaVal+50){Serial.println("esquerda");}  
        if(valorSensor8 > functionVal-50 && valorSensor1 < functionVal+50){Serial.println("function");}  
