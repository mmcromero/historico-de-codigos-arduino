...
int FLAGQuartinho  = LOW;  
int FLAGCozinha  = LOW;  
int FLAGArea  = LOW;  
int FLAGCorredor_1  = LOW;  
int FLAGCorredor_2  = LOW;  
int FLAGQuarto_arthur_1  = LOW;  
int FLAGQuarto_arthur_2  = LOW;  
int FLAGQuarto_arthur_3  = LOW; 
int FLAGBanheiro_social_1  = LOW;  
int FLAGBanheiro_social_2  = LOW;  
int FLAGBanheiro_suite_1  = LOW;  
int FLAGBanheiro_suite_2  = LOW;  
int FLAGQuarto_suite_1  = LOW;  
int FLAGQuarto_suite_2  = LOW;  
int FLAGQuarto_suite_3  = LOW;
